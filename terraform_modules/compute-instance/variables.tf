...
variable "instance_fault_domain" {
  description = "instance_fault_domain"
  type        = bool
  default     = true
}

variable "instance_availability_config_is_live_migration_preferred" {
  description = "instance_availability_config_is_live_migration_preferred"
  type        = bool
  default     = true
}
...
variable "instance_availability_config_recovery_action" {
  description = "The lifecycle state for an instance when it is recovered after infrastructure maintenance| values RESTORE_INSTANCE,STOP_INSTANCE "
